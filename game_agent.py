        ...
        **********************************************************************
        ...
        -----
            ...
            (2) If you use any helper functions (e.g., as shown in the AIMA
                ...
                testing.
        """
        # self = game_agent.MinimaxPlayer object
        # game = isolation.isolation.Board object

        # helpers:
        def terminal_test(game, self):
        ...
        def max_value(self, game, depth):
            ...
            if depth == 0 or terminal_test(game, self):
        ...
        def min_value(self, game, depth):
            ...
            if depth == 0 or terminal_test(game, game.active_player):
                return self.score(game, self)
            v = infinity
        ...
        **********************************************************************
        ...
        while True:
            try:
                # The try/except block will automatically catch the exception
                # raised when the timer is about to expire.
                best_move = self.alphabeta(game, depth_ID) #self.search_depth
                depth_ID = depth_ID + 1
            except SearchTimeout:
                return best_move
                #pass  # Handle any actions required after timeout as needed
